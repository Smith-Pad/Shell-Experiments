...
function content() {
	...
	print('<form method="post">');
        print('<input type="submit" name="cameraon" class="FOIL-button-regular-no-shadow" value="ON" />');
        print('<input type="submit" name="cameraoff" class="FOIL-button-regular-no-shadow" value="OFF" />');
        print('</form>');
        include('assets/turning.php');
}
content();
?>
